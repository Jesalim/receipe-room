    ...
    >
      <form onSubmit={handleSubmit} id="form">
        <div className="mb-4">
          ...
          <input
            className="bg-smoke w-full px-3 py-2 text-gray-700 border rounded"
            type="text"
            id="name"
            value={name}
        ...
        <div className="mb-4">
          ...
          <button
            className="button bg-bole hover:bg-bean hover:text-buff hover:bg-opacity-80 text-smoke text-[14px] uppercase font-black py-2 px-8 mt-2 mx-auto rounded w-40"
            type="button"
        ...
        <button
          className="button bg-bole hover:bg-bean hover:text-buff hover:bg-opacity-80 text-smoke text-[15px] uppercase font-black py-2 px-8 mt-2 mx-auto rounded w-40"
          type="submit"
        >
          Add Recipe
        </button>
